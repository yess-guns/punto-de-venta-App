...
export default {
  ...
  methods: {
    ...
    async edit() {
      this.btnSend = true;
      try {
        const path = `${this.BASE_URL}empleados/editEmpleado/`;
    ...
    openDialog(empleado){
      this.form.id_empleado = empleado.id_empleado;
      this.form.nombre = empleado.nombreEmpleado;
      this.form.ape = empleado.apellidosEmpleado;
      this.form.clave = empleado.claveAcceso;
      this.form.tipo = empleado.id_tipoEmpleado;
      this.dialog = true;
    },
